...
<div class="ctop2">
    <div class="ctop2a">
        ...
        <div class="ctop2a3"><img src="{{url('img/left.jpg')}}" width="154" height="91" usemap="#Map_manu" border="0">
            ...
            <div id="erweima" style="display:none; z-index:999999;"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></div>
        </div><br class="clear">
    </div>
</div>
<div class="ctop3">
            ...
            <form>
                ...
                <table width="170" border="0" cellspacing="0" cellpadding="0">
                    <tbody><tr>
                        ...
                        <td><input type="image" name="image" src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></td>
                    </tr>
                    </tbody></table>
            </form>
        </div><br class="clear">
            ...
            <div class="qh_con1x">
                <div class="qh_con1xa">
                    <div class="qh_con1xa1">
                        <h2>院况介绍</h2>
                        <img style="height: 200px" src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}">
                        <div class="scyxinjia">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{$item}}" target="_blank">
                                <img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="55" height="54">
                            </a>
        ...
        <div id="qh_con2" onmouseover="mynav2.className=&#39;mynav1&#39;;mynav2.style.color=&#39;#10218b&#39;;" onmouseout="mynav2.className=&#39;&#39;;mynav2.style.color=&#39;&#39;;" style="display: none;" class="ctop3az">
            <div class="qh_con2x">
                <div class="qh_con2xa">
                    ...
                    <img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}">
                </div>
                <div class="qh_con2xb">
                    <h2>先导专项</h2>
                    <ul>
                ...
                <div class="qh_con2xd">
                    ...
                    <h2>成果转化</h2>
                    <span class="qh_con2xdspan1"><img style="height: 200px" src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></span>
     ...
     <dd><a href="{{\App\Lable::LinkUrl()}}" title="产业化信息网" target="_blank">转化动态</a></dd>
        ...
        <div id="qh_con3" onmouseover="mynav3.className=&#39;mynav1&#39;;mynav3.style.color=&#39;#10218b&#39;;" onmouseout="mynav3.className=&#39;&#39;;mynav3.style.color=&#39;&#39;;" style="display: none;" class="ctop3az">
            <div class="qh_con3x">
                <div class="qh_con3xa">
                    ...
                    <a href="{{\App\Lable::LinkUrl()}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a>
        ...
        <div id="qh_con4" onmouseover="mynav4.className=&#39;mynav4&#39;;mynav4.style.color=&#39;#10218b&#39;;" onmouseout="mynav4.className=&#39;&#39;;mynav4.style.color=&#39;&#39;;" style="display: none;" class="ctop3az">
            ...
            <div class="qh_con4x">
                <div class="qh_con4xa">
                    ...
                    <dl>
                        <dd><a href="{{\App\Lable::LinkUrl()}}"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="214" height="46"></a></dd>
                        <dd><a href="{{\App\Lable::LinkUrl()}}"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="214" height="46"></a></dd>
                        <dd><a href="{{\App\Lable::LinkUrl()}}"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="214" height="46"></a></dd>
                    </dl>
                </div>
                ...
                <div class="qh_con4xd">
                    <h2><a href="{{\App\Lable::LinkUrl()}}" style="float:right;padding-left:15px;margin-right:10px;background: url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat left; font-weight: 400; display:block;">更多</a><span>工作动态</span></h2>
                    <ul>
        ...
        <div id="qh_con5" onmouseover="mynav5.className=&#39;mynav1&#39;;mynav5.style.color=&#39;#10218b&#39;;" onmouseout="mynav5.className=&#39;&#39;;mynav5.style.color=&#39;&#39;;" style="display: none;" class="ctop3az">
            <div class="qh_con5x">
                <div class="qh_con5xa">
                    <ul>
                        <li><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="科技战略咨询"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="科技战略咨询">科技战略咨询</a></li>
                        <li class="qh_con5xalix"><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="知识产权网"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="知识产权网">知识产权网</a></li>
                    </ul>
                    <ul>
                        <li><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="文献检索"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="文献检索">文献检索</a></li>
                        <li class="qh_con5xalix"><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="科技产业网"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="科技产业网">科技产业网</a></li>
                    </ul>
                    <ul class="qh_con5xaulx">
                        <li><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="信息化工作网"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="信息化工作网">信息化工作网</a></li>
                        <li class="qh_con5xalix qh_con5xaliy"><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="科技条件信息平台"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}"></a><br class="clear"><a href="{{\App\Lable::LinkUrl()}}" target="_blank" title="科技条件信息平台">科技条件信息平台</a></li>
                    </ul>
                </div>
                <div class="qh_con5xb">
                    <h2>出版物</h2>
                    ...
                    <ul>
                        <li><a href="{{\App\Lable::LinkUrl()}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="72" height="96"></a></li>
                        ...
                        <form>
                            ...
                            <table width="100%" height="40" border="0" cellspacing="0" cellpadding="0">
                                <tbody><tr>
                                    ...
                                    <td><input name="imageField2" type="image" src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" id="imageField2"></td>
                                </tr>
                                </tbody></table>
        ...
        <div id="qh_con6" onmouseover="mynav6.className=&#39;mynav1&#39;;mynav6.style.color=&#39;#10218b&#39;;" onmouseout="mynav6.className=&#39;&#39;;mynav6.style.color=&#39;&#39;;" style="display: none;" class="ctop3az">
            <div class="qh_con6x">
                <div class="qh_con6xa">
                    ...
                    <ul>
                        <li class="qh_con6xalix"><a href="{{\App\Lable::LinkUrl()}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="190" height="49"></a></li>
                        <li><a href="{{\App\Lable::LinkUrl()}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="221" height="59"></a></li>
                    </ul>
            ...
            @foreach(\App\Lable::LinkUrl(4) as $item)
                    <ul>
                        <li class="qh_con5xbliy"><a href="{{$item}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="91" height="64"></a></li>
            ...
            <div class="qh_con7x">
                ...
                <div class="qh_con7xc">
                    ...
                    <dl>
                        ...
                        <dd><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}">
        ...
        <style type="text/css">
            ...
            .scyhei20{background:url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat 20px;}
            .scyhei201{background:url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat 35px;}
            .scyhei202{background:url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat 38px;}
            ...
            .scyxxgk1{background:url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat 20px;}
            .scyxxgk{background:url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat;}
...
<div class="cztxxb">
    <div class="cztxxb1">
        ...
        <div class="cztxxb1z">
            ...
            <div class="bshare-custom" style="background:#fff;width:90px;border:1px solid #e5e5e5;padding:6px 0 6px 4px;position:absolute;top:12px;left:580px;">
                <span style="color:#077fd3; cursor:pointer;background:url(/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}) no-repeat right;" title="分享到" href="{{\App\Lable::LinkUrl()}}" id="bshare-shareto" class="">我要分享 &nbsp;</span><br>
    ...
    <div class="cztxxb2">
        ...
        <div class="cztxxb2b">
            ...
            @foreach(\App\Lable::LinkUrl(5) as $item)
            <ul>
                <li class="cztxxb2bli1"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="114" height="78"><span><a href="{{$item}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="114" height="78"></a></span></li>
        ...
        <div class="cztxxb2c">
            ...
            <ul>
                ...
                <li><a href="{{\App\Lable::LinkUrl()}}" target="_blank"><img src="/{{env('MULU')}}/{{\App\Lable::ImgUrl()}}" width="263" height="70"></a></li>
